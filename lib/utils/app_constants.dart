...
const kSpacingHeight64 = SizedBox(
  height: 64,
);
...
const kSpacingWidth36 = SizedBox(
  width: 36,
);
...
const kSpacingWidth64 = SizedBox(
  width: 64,
);

class AppConstants {

  static dynamic lessonInteractive;
  static dynamic plusPackage;
}